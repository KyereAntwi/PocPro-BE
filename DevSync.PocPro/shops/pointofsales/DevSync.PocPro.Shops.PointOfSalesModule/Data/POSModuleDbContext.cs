namespace DevSync.PocPro.Shops.PointOfSales.Data;

public class POSModuleDbContext: DbContext, IPOSDbContext
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly ITenantServices _tenantServices;

    public POSModuleDbContext(DbContextOptions<POSModuleDbContext> options, IHttpContextAccessor httpContextAccessor, ITenantServices tenantServices) : base(options)
    {
