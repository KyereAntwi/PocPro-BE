...
public class SendProductRatedEventHandler : BackgroundService
{
    private readonly RabbitMqConnectionFactory _factory;
    private readonly string _queueName = "update_product_rated";
    private IChannel _channel;
    private IConnection _connection;
    private ILogger<AddProductToQueryEventHandler> _logger;
    private IDocumentStore _documentStore;
    
    public SendProductRatedEventHandler(
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await _channel.QueueBindAsync(_queueName, "shop_exchange", "update_product_rated", cancellationToken: stoppingToken);
        ...
        consumer.ReceivedAsync += async (model, ea) =>
        {
            try
            {
                ...
                var eventObj = JsonSerializer.Deserialize<SendProductRatedEvent>(message);
                if (eventObj == null)
                ...
                existingProduct.Ratings = eventObj.Ratings;
