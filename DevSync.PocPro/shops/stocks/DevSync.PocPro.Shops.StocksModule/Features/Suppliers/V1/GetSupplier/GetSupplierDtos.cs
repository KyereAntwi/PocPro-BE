...
public record GetSupplierResponse(Guid Id, string Title, string Email, IEnumerable<ContactResponse> Contacts, DateTimeOffset? CreatedAt, DateTimeOffset? UpdatedAt);
