namespace DevSync.PocPro.Shops.PromoCodesModule.Data;

public class PromoCodeModuleDbContext: DbContext, IPromoCodeModuleDbContext
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly ITenantServices _tenantServices;

    public PromoCodeModuleDbContext(DbContextOptions<PromoCodeModuleDbContext> options, IHttpContextAccessor httpContextAccessor, ITenantServices tenantServices)
    : base(options)
    {
