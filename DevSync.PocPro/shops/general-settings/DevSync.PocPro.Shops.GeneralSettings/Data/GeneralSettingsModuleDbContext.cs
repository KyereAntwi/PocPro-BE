namespace DevSync.PocPro.Shops.GeneralSettings.Data;

public class GeneralSettingsModuleDbContext : DbContext, IGeneralSettingsModuleDbContext
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly ITenantServices _tenantServices;

    public GeneralSettingsModuleDbContext(DbContextOptions<GeneralSettingsModuleDbContext> options, IHttpContextAccessor httpContextAccessor, ITenantServices tenantServices) 
        : base(options)
    {
